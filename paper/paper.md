...
Thermal models of subduction zones require high numerical resolution, 
...
Semi-analytical techniques can be used successfully along the shallow plate interface to limited depth [@vanKeken2019], 
