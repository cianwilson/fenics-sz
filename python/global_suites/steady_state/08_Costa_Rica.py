...
if __name__ == "__main__" and "__file__" not in globals():
    ...
    get_ipython().system('jupyter nbconvert --NbConvertApp.export_format=script --ClearOutputPreprocessor.enabled=True --FilesWriter.build_directory=../../../python/global_suites/steady_state --NbConvertApp.output_base=08_Costa_Rica 08_Costa_Rica.ipynb')
