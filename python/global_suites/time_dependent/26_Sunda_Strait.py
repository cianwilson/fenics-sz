...
if __name__ == "__main__" and "__file__" not in globals():
    ...
    get_ipython().system('jupyter nbconvert --NbConvertApp.export_format=script --ClearOutputPreprocessor.enabled=True --FilesWriter.build_directory=../../../python/global_suites/time_dependent --NbConvertApp.output_base=26_Sunda_Strait 26_Sunda_Strait.ipynb')
