...
The easiest way to read this [Jupyter Book](https://jupyterbook.org/) is on the [FEniCS-SZ website](https://cianwilson.github.io/fenics-sz) however all the pages of the book can also be run interactively in a web browser from any jupyter server with the appropriate software packages installed.  The python modules developed in these notebooks can also be installed as a python package.  Please see our [usage page](https://cianwilson.github.io/fenics-sz/notebooks/01_introduction/1.2_usage.html) for details on how to run the notebooks online or locally.
